...
const Modal = (props: { children: React.ReactNode }) => {
  ...
  return (
    <div className="modal-wrapper h-vh inset-0 grid grid-cols-12 gap-x-3 gap-y-4 overflow-y-scroll p-2 pb-6 lg:grid-rows-1 lg:p-6">
      <div className="modalWrapper relative col-span-full grid h-max min-h-full grid-cols-subgrid grid-rows-[--spacing(8)_repeat(auto-fill,minmax(0,1fr))] overflow-visible">
        <button
          onClick={() => router.back()}
