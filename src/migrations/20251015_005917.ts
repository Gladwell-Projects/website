...
export async function up({ db, payload, req }: MigrateUpArgs): Promise<void> {
  ...
  await db.run(sql`CREATE TABLE \`__new_press\` (
  	\`id\` text(36) PRIMARY KEY NOT NULL,
  	\`strapline\` text,
  	\`title\` text,
  	\`generate_slug\` integer DEFAULT true,
  ...
  `)
  await db.run(sql`INSERT INTO \`__new_press\`("id", "strapline", "title", "generate_slug", "slug", "date", "content", "featured_image_id", "meta_title", "meta_description", "meta_image_id", "updated_at", "created_at", "_status") SELECT "id", "strapline", "title", "generate_slug", "slug", "date", "content", "featured_image_id", "meta_title", "meta_description", "meta_image_id", "updated_at", "created_at", "_status" FROM \`press\`;`)
  await db.run(sql`DROP TABLE \`press\`;`)
  await db.run(sql`ALTER TABLE \`__new_press\` RENAME TO \`press\`;`)
  await db.run(sql`CREATE UNIQUE INDEX \`press_slug_idx\` ON \`press\` (\`slug\`);`)
  ...
  `)
  await db.run(sql`INSERT INTO \`__new_events\`("id", "title", "start_date", "startdate_tz", "end_date", "enddate_tz", "has_time", "generate_slug", "slug", "featured_image_id", "location", "content", "is_linked", "link_type", "link_new_tab", "link_url", "link_upload_id", "link_label", "link_custom_id", "meta_title", "meta_description", "meta_image_id", "updated_at", "created_at", "_status") SELECT "id", "title", "start_date", "startdate_tz", "end_date", "enddate_tz", "has_time", "generate_slug", "slug", "featured_image_id", "location", "content", "is_linked", "link_type", "link_new_tab", "link_url", "link_upload_id", "link_label", "link_custom_id", "meta_title", "meta_description", "meta_image_id", "updated_at", "created_at", "_status" FROM \`events\`;`)
  ...
  `)
  await db.run(sql`INSERT INTO \`__new_artists_rels\`("id", "order", "parent_id", "path", "media_id") SELECT "id", "order", "parent_id", "path", "media_id" FROM \`artists_rels\`;`)
  ...
  await db.run(sql`CREATE TABLE \`__new__artists_v_rels\` (
  	\`id\` integer PRIMARY KEY NOT NULL,
  	\`order\` integer,
  	\`parent_id\` text(36) NOT NULL,
  	\`path\` text NOT NULL,
  ...
  `)
  await db.run(sql`INSERT INTO \`__new__artists_v_rels\`("id", "order", "parent_id", "path", "media_id") SELECT "id", "order", "parent_id", "path", "media_id" FROM \`_artists_v_rels\`;`)
  await db.run(sql`DROP TABLE \`_artists_v_rels\`;`)
  await db.run(sql`ALTER TABLE \`__new__artists_v_rels\` RENAME TO \`_artists_v_rels\`;`)
  ...
  await db.run(sql`CREATE TABLE \`__new_exhibitions_rels\` (
  	\`id\` integer PRIMARY KEY NOT NULL,
  	\`order\` integer,
  	\`parent_id\` text(36) NOT NULL,
  	\`path\` text NOT NULL,
  ...
  `)
  await db.run(sql`INSERT INTO \`__new_exhibitions_rels\`("id", "order", "parent_id", "path", "artists_id", "media_id") SELECT "id", "order", "parent_id", "path", "artists_id", "media_id" FROM \`exhibitions_rels\`;`)
  await db.run(sql`DROP TABLE \`exhibitions_rels\`;`)
  await db.run(sql`ALTER TABLE \`__new_exhibitions_rels\` RENAME TO \`exhibitions_rels\`;`)
  ...
  await db.run(sql`CREATE TABLE \`__new__exhibitions_v_rels\` (
  	\`id\` integer PRIMARY KEY NOT NULL,
  	\`order\` integer,
  	\`parent_id\` text(36) NOT NULL,
  	\`path\` text NOT NULL,
  ...
  `)
  await db.run(sql`INSERT INTO \`__new__exhibitions_v_rels\`("id", "order", "parent_id", "path", "artists_id", "media_id") SELECT "id", "order", "parent_id", "path", "artists_id", "media_id" FROM \`_exhibitions_v_rels\`;`)
  await db.run(sql`DROP TABLE \`_exhibitions_v_rels\`;`)
  await db.run(sql`ALTER TABLE \`__new__exhibitions_v_rels\` RENAME TO \`_exhibitions_v_rels\`;`)
  ...
  await db.run(sql`CREATE TABLE \`__new_press_links\` (
  ...
  `)
  await db.run(sql`INSERT INTO \`__new_press_links\`("_order", "_parent_id", "id", "link_type", "link_new_tab", "link_url", "link_upload_id", "link_label", "link_custom_id") SELECT "_order", "_parent_id", "id", "link_type", "link_new_tab", "link_url", "link_upload_id", "link_label", "link_custom_id" FROM \`press_links\`;`)
  await db.run(sql`DROP TABLE \`press_links\`;`)
  await db.run(sql`ALTER TABLE \`__new_press_links\` RENAME TO \`press_links\`;`)
  ...
  await db.run(sql`CREATE TABLE \`__new__press_v_version_links\` (
  	\`_order\` integer NOT NULL,
  	\`_parent_id\` text(36) NOT NULL,
  	\`id\` text(36) PRIMARY KEY NOT NULL,
  	\`link_type\` text DEFAULT 'reference',
  ...
  `)
  await db.run(sql`INSERT INTO \`__new__press_v_version_links\`("_order", "_parent_id", "id", "link_type", "link_new_tab", "link_url", "link_upload_id", "link_label", "link_custom_id", "_uuid") SELECT "_order", "_parent_id", "id", "link_type", "link_new_tab", "link_url", "link_upload_id", "link_label", "link_custom_id", "_uuid" FROM \`_press_v_version_links\`;`)
  await db.run(sql`DROP TABLE \`_press_v_version_links\`;`)
  await db.run(sql`ALTER TABLE \`__new__press_v_version_links\` RENAME TO \`_press_v_version_links\`;`)
  ...
  await db.run(sql`CREATE TABLE \`__new__press_v\` (
  	\`id\` text(36) PRIMARY KEY NOT NULL,
  	\`parent_id\` text(36),
  	...
  	\`version_date\` text,
  	\`version_content\` text,
  	\`version_featured_image_id\` text(36),
  	\`version_meta_title\` text,
  	\`version_meta_description\` text,
  	\`version_meta_image_id\` text(36),
  	\`version_updated_at\` text,
  ...
  `)
  await db.run(sql`INSERT INTO \`__new__press_v\`("id", "parent_id", "version_strapline", "version_title", "version_generate_slug", "version_slug", "version_date", "version_content", "version_featured_image_id", "version_meta_title", "version_meta_description", "version_meta_image_id", "version_updated_at", "version_created_at", "version__status", "created_at", "updated_at", "latest") SELECT "id", "parent_id", "version_strapline", "version_title", "version_generate_slug", "version_slug", "version_date", "version_content", "version_featured_image_id", "version_meta_title", "version_meta_description", "version_meta_image_id", "version_updated_at", "version_created_at", "version__status", "created_at", "updated_at", "latest" FROM \`_press_v\`;`)
  await db.run(sql`DROP TABLE \`_press_v\`;`)
  await db.run(sql`ALTER TABLE \`__new__press_v\` RENAME TO \`_press_v\`;`)
  ...
  await db.run(sql`CREATE TABLE \`__new_events_rels\` (
  	\`id\` integer PRIMARY KEY NOT NULL,
  	\`order\` integer,
  	\`parent_id\` text(36) NOT NULL,
  	\`path\` text NOT NULL,
  ...
  `)
  await db.run(sql`INSERT INTO \`__new_events_rels\`("id", "order", "parent_id", "path", "exhibitions_id", "pages_id", "artists_id", "press_id", "events_id", "viewing_rooms_id") SELECT "id", "order", "parent_id", "path", "exhibitions_id", "pages_id", "artists_id", "press_id", "events_id", "viewing_rooms_id" FROM \`events_rels\`;`)
  await db.run(sql`DROP TABLE \`events_rels\`;`)
  await db.run(sql`ALTER TABLE \`__new_events_rels\` RENAME TO \`events_rels\`;`)
  ...
  await db.run(sql`CREATE TABLE \`__new__events_v\` (
  	...
  	\`version_link_upload_id\` text(36),
  ...
  `)
  await db.run(sql`INSERT INTO \`__new__events_v\`("id", "parent_id", "version_title", "version_start_date", "version_startdate_tz", "version_end_date", "version_enddate_tz", "version_has_time", "version_generate_slug", "version_slug", "version_featured_image_id", "version_location", "version_content", "version_is_linked", "version_link_type", "version_link_new_tab", "version_link_url", "version_link_upload_id", "version_link_label", "version_link_custom_id", "version_meta_title", "version_meta_description", "version_meta_image_id", "version_updated_at", "version_created_at", "version__status", "created_at", "updated_at", "latest") SELECT "id", "parent_id", "version_title", "version_start_date", "version_startdate_tz", "version_end_date", "version_enddate_tz", "version_has_time", "version_generate_slug", "version_slug", "version_featured_image_id", "version_location", "version_content", "version_is_linked", "version_link_type", "version_link_new_tab", "version_link_url", "version_link_upload_id", "version_link_label", "version_link_custom_id", "version_meta_title", "version_meta_description", "version_meta_image_id", "version_updated_at", "version_created_at", "version__status", "created_at", "updated_at", "latest" FROM \`_events_v\`;`)
  ...
  await db.run(sql`CREATE TABLE \`__new__events_v_rels\` (
  	\`id\` integer PRIMARY KEY NOT NULL,
  	\`order\` integer,
  	\`parent_id\` text(36) NOT NULL,
  	\`path\` text NOT NULL,
  ...
  `)
  await db.run(sql`INSERT INTO \`__new__events_v_rels\`("id", "order", "parent_id", "path", "exhibitions_id", "pages_id", "artists_id", "press_id", "events_id", "viewing_rooms_id") SELECT "id", "order", "parent_id", "path", "exhibitions_id", "pages_id", "artists_id", "press_id", "events_id", "viewing_rooms_id" FROM \`_events_v_rels\`;`)
  await db.run(sql`DROP TABLE \`_events_v_rels\`;`)
  await db.run(sql`ALTER TABLE \`__new__events_v_rels\` RENAME TO \`_events_v_rels\`;`)
  ...
  await db.run(sql`CREATE TABLE \`__new_clients_sessions\` (
  	\`_order\` integer NOT NULL,
  	\`_parent_id\` text(36) NOT NULL,
  	\`id\` text PRIMARY KEY NOT NULL,
  	\`created_at\` text,
  ...
  `)
  await db.run(sql`INSERT INTO \`__new_clients_sessions\`("_order", "_parent_id", "id", "created_at", "expires_at") SELECT "_order", "_parent_id", "id", "created_at", "expires_at" FROM \`clients_sessions\`;`)
  await db.run(sql`DROP TABLE \`clients_sessions\`;`)
  await db.run(sql`ALTER TABLE \`__new_clients_sessions\` RENAME TO \`clients_sessions\`;`)
  ...
  `)
  await db.run(sql`INSERT INTO \`__new_clients\`("id", "name", "role", "updated_at", "created_at", "email", "reset_password_token", "reset_password_expiration", "salt", "hash", "login_attempts", "lock_until") SELECT "id", "name", "role", "updated_at", "created_at", "email", "reset_password_token", "reset_password_expiration", "salt", "hash", "login_attempts", "lock_until" FROM \`clients\`;`)
  ...
  await db.run(sql`CREATE TABLE \`__new_payload_locked_documents\` (
  	\`id\` text(36) PRIMARY KEY NOT NULL,
  	\`global_slug\` text,
  	\`updated_at\` text DEFAULT (strftime('%Y-%m-%dT%H:%M:%fZ', 'now')) NOT NULL,
  	\`created_at\` text DEFAULT (strftime('%Y-%m-%dT%H:%M:%fZ', 'now')) NOT NULL
  ...
  `)
  await db.run(sql`INSERT INTO \`__new_payload_locked_documents\`("id", "global_slug", "updated_at", "created_at") SELECT "id", "global_slug", "updated_at", "created_at" FROM \`payload_locked_documents\`;`)
  await db.run(sql`DROP TABLE \`payload_locked_documents\`;`)
  await db.run(sql`ALTER TABLE \`__new_payload_locked_documents\` RENAME TO \`payload_locked_documents\`;`)
  ...
  await db.run(sql`CREATE TABLE \`__new_payload_preferences\` (
  	\`id\` text(36) PRIMARY KEY NOT NULL,
  	\`key\` text,
  	\`value\` text,
  	\`updated_at\` text DEFAULT (strftime('%Y-%m-%dT%H:%M:%fZ', 'now')) NOT NULL,
  ...
  `)
  await db.run(sql`INSERT INTO \`__new_payload_preferences\`("id", "key", "value", "updated_at", "created_at") SELECT "id", "key", "value", "updated_at", "created_at" FROM \`payload_preferences\`;`)
  await db.run(sql`DROP TABLE \`payload_preferences\`;`)
  await db.run(sql`ALTER TABLE \`__new_payload_preferences\` RENAME TO \`payload_preferences\`;`)
  ...
  `)
  await db.run(sql`INSERT INTO \`__new_payload_preferences_rels\`("id", "order", "parent_id", "path", "users_id", "clients_id") SELECT "id", "order", "parent_id", "path", "users_id", "clients_id" FROM \`payload_preferences_rels\`;`)
  ...
  await db.run(sql`CREATE TABLE \`__new_payload_migrations\` (
  	\`id\` text(36) PRIMARY KEY NOT NULL,
  	\`name\` text,
  	\`batch\` numeric,
  	\`updated_at\` text DEFAULT (strftime('%Y-%m-%dT%H:%M:%fZ', 'now')) NOT NULL,
  ...
  `)
  await db.run(sql`INSERT INTO \`__new_payload_migrations\`("id", "name", "batch", "updated_at", "created_at") SELECT "id", "name", "batch", "updated_at", "created_at" FROM \`payload_migrations\`;`)
  await db.run(sql`DROP TABLE \`payload_migrations\`;`)
  await db.run(sql`ALTER TABLE \`__new_payload_migrations\` RENAME TO \`payload_migrations\`;`)
  await db.run(sql`CREATE INDEX \`payload_migrations_updated_at_idx\` ON \`payload_migrations\` (\`updated_at\`);`)
  await db.run(sql`CREATE INDEX \`payload_migrations_created_at_idx\` ON \`payload_migrations\` (\`created_at\`);`)
  await db.run(sql`CREATE TABLE \`__new_payload_query_presets\` (
  	\`id\` text(36) PRIMARY KEY NOT NULL,
  	\`title\` text NOT NULL,
  ...
  `)
  await db.run(sql`INSERT INTO \`__new_payload_query_presets\`("id", "title", "is_shared", "access_read_constraint", "access_update_constraint", "access_delete_constraint", "where", "columns", "related_collection", "is_temp", "updated_at", "created_at") SELECT "id", "title", "is_shared", "access_read_constraint", "access_update_constraint", "access_delete_constraint", "where", "columns", "related_collection", "is_temp", "updated_at", "created_at" FROM \`payload_query_presets\`;`)
  await db.run(sql`DROP TABLE \`payload_query_presets\`;`)
  await db.run(sql`ALTER TABLE \`__new_payload_query_presets\` RENAME TO \`payload_query_presets\`;`)
  ...
  await db.run(sql`CREATE TABLE \`__new_payload_query_presets_rels\` (
  	\`id\` integer PRIMARY KEY NOT NULL,
  	\`order\` integer,
  	\`parent_id\` text(36) NOT NULL,
  	\`path\` text NOT NULL,
  ...
  `)
  await db.run(sql`INSERT INTO \`__new_payload_query_presets_rels\`("id", "order", "parent_id", "path", "users_id") SELECT "id", "order", "parent_id", "path", "users_id" FROM \`payload_query_presets_rels\`;`)
  await db.run(sql`DROP TABLE \`payload_query_presets_rels\`;`)
  await db.run(sql`ALTER TABLE \`__new_payload_query_presets_rels\` RENAME TO \`payload_query_presets_rels\`;`)
  ...
  await db.run(sql`CREATE TABLE \`__new_main_menu_menu_items_top\` (
  	\`_order\` integer NOT NULL,
  	\`_parent_id\` text(36) NOT NULL,
  	\`id\` text PRIMARY KEY NOT NULL,
  	\`label\` text NOT NULL,
  ...
  `)
  await db.run(sql`INSERT INTO \`__new_main_menu_menu_items_top\`("_order", "_parent_id", "id", "label", "theme", "link_type", "link_new_tab", "link_url", "link_upload_id", "link_custom_id") SELECT "_order", "_parent_id", "id", "label", "theme", "link_type", "link_new_tab", "link_url", "link_upload_id", "link_custom_id" FROM \`main_menu_menu_items_top\`;`)
  await db.run(sql`DROP TABLE \`main_menu_menu_items_top\`;`)
  await db.run(sql`ALTER TABLE \`__new_main_menu_menu_items_top\` RENAME TO \`main_menu_menu_items_top\`;`)
  ...
  await db.run(sql`CREATE TABLE \`__new_main_menu_menu_items_bot\` (
  	\`_order\` integer NOT NULL,
  	\`_parent_id\` text(36) NOT NULL,
  	\`id\` text PRIMARY KEY NOT NULL,
  	\`label\` text NOT NULL,
  ...
  `)
  await db.run(sql`INSERT INTO \`__new_main_menu_menu_items_bot\`("_order", "_parent_id", "id", "label", "theme", "link_type", "link_new_tab", "link_url", "link_upload_id", "link_custom_id") SELECT "_order", "_parent_id", "id", "label", "theme", "link_type", "link_new_tab", "link_url", "link_upload_id", "link_custom_id" FROM \`main_menu_menu_items_bot\`;`)
  await db.run(sql`DROP TABLE \`main_menu_menu_items_bot\`;`)
  await db.run(sql`ALTER TABLE \`__new_main_menu_menu_items_bot\` RENAME TO \`main_menu_menu_items_bot\`;`)
  ...
  await db.run(sql`CREATE TABLE \`__new_main_menu\` (
  	\`id\` text(36) PRIMARY KEY NOT NULL,
  	\`updated_at\` text,
  	\`created_at\` text
  );
  `)
  await db.run(sql`INSERT INTO \`__new_main_menu\`("id", "updated_at", "created_at") SELECT "id", "updated_at", "created_at" FROM \`main_menu\`;`)
  await db.run(sql`DROP TABLE \`main_menu\`;`)
  await db.run(sql`ALTER TABLE \`__new_main_menu\` RENAME TO \`main_menu\`;`)
  await db.run(sql`CREATE TABLE \`__new_main_menu_rels\` (
  	\`id\` integer PRIMARY KEY NOT NULL,
  	\`order\` integer,
  	\`parent_id\` text(36) NOT NULL,
  	\`path\` text NOT NULL,
  ...
  `)
  await db.run(sql`INSERT INTO \`__new_main_menu_rels\`("id", "order", "parent_id", "path", "pages_id", "artists_id", "exhibitions_id", "press_id", "events_id", "viewing_rooms_id") SELECT "id", "order", "parent_id", "path", "pages_id", "artists_id", "exhibitions_id", "press_id", "events_id", "viewing_rooms_id" FROM \`main_menu_rels\`;`)
  await db.run(sql`DROP TABLE \`main_menu_rels\`;`)
  await db.run(sql`ALTER TABLE \`__new_main_menu_rels\` RENAME TO \`main_menu_rels\`;`)
  ...
  await db.run(sql`CREATE TABLE \`__new_branding_social_links\` (
  	\`_order\` integer NOT NULL,
  	\`_parent_id\` text(36) NOT NULL,
  	\`id\` text PRIMARY KEY NOT NULL,
  	\`type\` text,
  ...
  `)
  await db.run(sql`INSERT INTO \`__new_branding_social_links\`("_order", "_parent_id", "id", "type", "url", "icon_id", "at") SELECT "_order", "_parent_id", "id", "type", "url", "icon_id", "at" FROM \`branding_social_links\`;`)
  await db.run(sql`DROP TABLE \`branding_social_links\`;`)
  await db.run(sql`ALTER TABLE \`__new_branding_social_links\` RENAME TO \`branding_social_links\`;`)
  ...
  await db.run(sql`CREATE TABLE \`__new_branding\` (
  	\`id\` text(36) PRIMARY KEY NOT NULL,
  	\`logo_id\` text(36),
  	\`title\` text,
  	\`description\` text,
  ...
  `)
  await db.run(sql`INSERT INTO \`__new_branding\`("id", "logo_id", "title", "description", "author", "keywords", "updated_at", "created_at") SELECT "id", "logo_id", "title", "description", "author", "keywords", "updated_at", "created_at" FROM \`branding\`;`)
  await db.run(sql`DROP TABLE \`branding\`;`)
  await db.run(sql`ALTER TABLE \`__new_branding\` RENAME TO \`branding\`;`)
  await db.run(sql`CREATE INDEX \`branding_logo_idx\` ON \`branding\` (\`logo_id\`);`)
  await db.run(sql`CREATE TABLE \`__new_footer_links_primary\` (
  	\`_order\` integer NOT NULL,
  	\`_parent_id\` text(36) NOT NULL,
  	\`id\` text PRIMARY KEY NOT NULL,
  	\`label\` text NOT NULL,
  ...
  `)
  await db.run(sql`INSERT INTO \`__new_footer_links_primary\`("_order", "_parent_id", "id", "label", "link_type", "link_new_tab", "link_url", "link_upload_id", "link_custom_id") SELECT "_order", "_parent_id", "id", "label", "link_type", "link_new_tab", "link_url", "link_upload_id", "link_custom_id" FROM \`footer_links_primary\`;`)
  await db.run(sql`DROP TABLE \`footer_links_primary\`;`)
  await db.run(sql`ALTER TABLE \`__new_footer_links_primary\` RENAME TO \`footer_links_primary\`;`)
  ...
  await db.run(sql`CREATE TABLE \`__new_footer_links_secondary\` (
  	\`_order\` integer NOT NULL,
  	\`_parent_id\` text(36) NOT NULL,
  	\`id\` text PRIMARY KEY NOT NULL,
  	\`label\` text NOT NULL,
  ...
  `)
  await db.run(sql`INSERT INTO \`__new_footer_links_secondary\`("_order", "_parent_id", "id", "label", "link_type", "link_new_tab", "link_url", "link_upload_id", "link_custom_id") SELECT "_order", "_parent_id", "id", "label", "link_type", "link_new_tab", "link_url", "link_upload_id", "link_custom_id" FROM \`footer_links_secondary\`;`)
  await db.run(sql`DROP TABLE \`footer_links_secondary\`;`)
  await db.run(sql`ALTER TABLE \`__new_footer_links_secondary\` RENAME TO \`footer_links_secondary\`;`)
  ...
  `)
  await db.run(sql`INSERT INTO \`__new_footer\`("id", "tagline", "site_description", "show_copyright", "updated_at", "created_at") SELECT "id", "tagline", "site_description", "show_copyright", "updated_at", "created_at" FROM \`footer\`;`)
  await db.run(sql`DROP TABLE \`footer\`;`)
  await db.run(sql`ALTER TABLE \`__new_footer\` RENAME TO \`footer\`;`)
  await db.run(sql`CREATE TABLE \`__new_footer_rels\` (
  	\`id\` integer PRIMARY KEY NOT NULL,
  	\`order\` integer,
  	\`parent_id\` text(36) NOT NULL,
  	\`path\` text NOT NULL,
  ...
  `)
  await db.run(sql`INSERT INTO \`__new_footer_rels\`("id", "order", "parent_id", "path", "pages_id", "artists_id", "exhibitions_id", "press_id", "events_id", "viewing_rooms_id") SELECT "id", "order", "parent_id", "path", "pages_id", "artists_id", "exhibitions_id", "press_id", "events_id", "viewing_rooms_id" FROM \`footer_rels\`;`)
  await db.run(sql`DROP TABLE \`footer_rels\`;`)
  await db.run(sql`ALTER TABLE \`__new_footer_rels\` RENAME TO \`footer_rels\`;`)
...
export async function down({ db, payload, req }: MigrateDownArgs): Promise<void> {
  ...
  `)
  await db.run(sql`INSERT INTO \`__new_artists\`("id", "title", "slug", "slug_lock", "is_represented", "profile_image_id", "first_name", "middle_name", "last_name", "suffix", "nationality", "birth_year", "death_year", "content", "social_links_website", "social_links_instagram", "social_links_twitter", "cv_upload_id", "meta_title", "meta_description", "meta_image_id", "updated_at", "created_at", "_status") SELECT "id", "title", "slug", "slug_lock", "is_represented", "profile_image_id", "first_name", "middle_name", "last_name", "suffix", "nationality", "birth_year", "death_year", "content", "social_links_website", "social_links_instagram", "social_links_twitter", "cv_upload_id", "meta_title", "meta_description", "meta_image_id", "updated_at", "created_at", "_status" FROM \`artists\`;`)
  await db.run(sql`DROP TABLE \`artists\`;`)
  await db.run(sql`ALTER TABLE \`__new_artists\` RENAME TO \`artists\`;`)
  await db.run(sql`PRAGMA foreign_keys=ON;`)
  ...
  `)
  await db.run(sql`INSERT INTO \`__new_exhibitions\`("id", "start_date", "startdate_tz", "end_date", "enddate_tz", "location", "slug", "slug_lock", "title", "content", "cover_image_id", "meta_title", "meta_description", "meta_image_id", "updated_at", "created_at", "_status") SELECT "id", "start_date", "startdate_tz", "end_date", "enddate_tz", "location", "slug", "slug_lock", "title", "content", "cover_image_id", "meta_title", "meta_description", "meta_image_id", "updated_at", "created_at", "_status" FROM \`exhibitions\`;`)
  await db.run(sql`DROP TABLE \`exhibitions\`;`)
  await db.run(sql`ALTER TABLE \`__new_exhibitions\` RENAME TO \`exhibitions\`;`)
  ...
  `)
  await db.run(sql`INSERT INTO \`__new_press\`("id", "strapline", "title", "slug", "slug_lock", "date", "content", "featured_image_id", "meta_title", "meta_description", "meta_image_id", "updated_at", "created_at", "_status") SELECT "id", "strapline", "title", "slug", "slug_lock", "date", "content", "featured_image_id", "meta_title", "meta_description", "meta_image_id", "updated_at", "created_at", "_status" FROM \`press\`;`)
  await db.run(sql`DROP TABLE \`press\`;`)
  await db.run(sql`ALTER TABLE \`__new_press\` RENAME TO \`press\`;`)
  ...
  `)
  await db.run(sql`INSERT INTO \`__new_pages\`("id", "title", "slug", "slug_lock", "theme", "content", "parent_id", "meta_title", "meta_description", "meta_image_id", "updated_at", "created_at", "_status") SELECT "id", "title", "slug", "slug_lock", "theme", "content", "parent_id", "meta_title", "meta_description", "meta_image_id", "updated_at", "created_at", "_status" FROM \`pages\`;`)
  await db.run(sql`DROP TABLE \`pages\`;`)
  await db.run(sql`ALTER TABLE \`__new_pages\` RENAME TO \`pages\`;`)
  ...
  `)
  await db.run(sql`INSERT INTO \`__new_viewing_rooms\`("id", "title", "content", "slug", "slug_lock", "updated_at", "created_at") SELECT "id", "title", "content", "slug", "slug_lock", "updated_at", "created_at" FROM \`viewing_rooms\`;`)
  await db.run(sql`DROP TABLE \`viewing_rooms\`;`)
  await db.run(sql`ALTER TABLE \`__new_viewing_rooms\` RENAME TO \`viewing_rooms\`;`)
  ...
  `)
  await db.run(sql`INSERT INTO \`__new__artists_v\`("id", "parent_id", "version_title", "version_slug", "version_slug_lock", "version_is_represented", "version_profile_image_id", "version_first_name", "version_middle_name", "version_last_name", "version_suffix", "version_nationality", "version_birth_year", "version_death_year", "version_content", "version_social_links_website", "version_social_links_instagram", "version_social_links_twitter", "version_cv_upload_id", "version_meta_title", "version_meta_description", "version_meta_image_id", "version_updated_at", "version_created_at", "version__status", "created_at", "updated_at", "latest") SELECT "id", "parent_id", "version_title", "version_slug", "version_slug_lock", "version_is_represented", "version_profile_image_id", "version_first_name", "version_middle_name", "version_last_name", "version_suffix", "version_nationality", "version_birth_year", "version_death_year", "version_content", "version_social_links_website", "version_social_links_instagram", "version_social_links_twitter", "version_cv_upload_id", "version_meta_title", "version_meta_description", "version_meta_image_id", "version_updated_at", "version_created_at", "version__status", "created_at", "updated_at", "latest" FROM \`_artists_v\`;`)
  await db.run(sql`DROP TABLE \`_artists_v\`;`)
  await db.run(sql`ALTER TABLE \`__new__artists_v\` RENAME TO \`_artists_v\`;`)
  await db.run(sql`CREATE INDEX \`_artists_v_parent_idx\` ON \`_artists_v\` (\`parent_id\`);`)
  await db.run(sql`CREATE INDEX \`_artists_v_version_version_slug_idx\` ON \`_artists_v\` (\`version_slug\`);`)
  ...
  `)
  await db.run(sql`INSERT INTO \`__new__exhibitions_v\`("id", "parent_id", "version_start_date", "version_startdate_tz", "version_end_date", "version_enddate_tz", "version_location", "version_slug", "version_slug_lock", "version_title", "version_content", "version_cover_image_id", "version_meta_title", "version_meta_description", "version_meta_image_id", "version_updated_at", "version_created_at", "version__status", "created_at", "updated_at", "latest") SELECT "id", "parent_id", "version_start_date", "version_startdate_tz", "version_end_date", "version_enddate_tz", "version_location", "version_slug", "version_slug_lock", "version_title", "version_content", "version_cover_image_id", "version_meta_title", "version_meta_description", "version_meta_image_id", "version_updated_at", "version_created_at", "version__status", "created_at", "updated_at", "latest" FROM \`_exhibitions_v\`;`)
  await db.run(sql`DROP TABLE \`_exhibitions_v\`;`)
  await db.run(sql`ALTER TABLE \`__new__exhibitions_v\` RENAME TO \`_exhibitions_v\`;`)
  await db.run(sql`CREATE INDEX \`_exhibitions_v_parent_idx\` ON \`_exhibitions_v\` (\`parent_id\`);`)
  await db.run(sql`CREATE INDEX \`_exhibitions_v_version_version_slug_idx\` ON \`_exhibitions_v\` (\`version_slug\`);`)
  ...
  `)
  await db.run(sql`INSERT INTO \`__new__press_v\`("id", "parent_id", "version_strapline", "version_title", "version_slug", "version_slug_lock", "version_date", "version_content", "version_featured_image_id", "version_meta_title", "version_meta_description", "version_meta_image_id", "version_updated_at", "version_created_at", "version__status", "created_at", "updated_at", "latest") SELECT "id", "parent_id", "version_strapline", "version_title", "version_slug", "version_slug_lock", "version_date", "version_content", "version_featured_image_id", "version_meta_title", "version_meta_description", "version_meta_image_id", "version_updated_at", "version_created_at", "version__status", "created_at", "updated_at", "latest" FROM \`_press_v\`;`)
  await db.run(sql`DROP TABLE \`_press_v\`;`)
  await db.run(sql`ALTER TABLE \`__new__press_v\` RENAME TO \`_press_v\`;`)
  await db.run(sql`CREATE INDEX \`_press_v_parent_idx\` ON \`_press_v\` (\`parent_id\`);`)
  await db.run(sql`CREATE INDEX \`_press_v_version_version_slug_idx\` ON \`_press_v\` (\`version_slug\`);`)
  ...
  `)
  await db.run(sql`INSERT INTO \`__new__pages_v\`("id", "parent_id", "version_title", "version_slug", "version_slug_lock", "version_theme", "version_content", "version_parent_id", "version_meta_title", "version_meta_description", "version_meta_image_id", "version_updated_at", "version_created_at", "version__status", "created_at", "updated_at", "latest", "autosave") SELECT "id", "parent_id", "version_title", "version_slug", "version_slug_lock", "version_theme", "version_content", "version_parent_id", "version_meta_title", "version_meta_description", "version_meta_image_id", "version_updated_at", "version_created_at", "version__status", "created_at", "updated_at", "latest", "autosave" FROM \`_pages_v\`;`)
  await db.run(sql`DROP TABLE \`_pages_v\`;`)
  await db.run(sql`ALTER TABLE \`__new__pages_v\` RENAME TO \`_pages_v\`;`)
  await db.run(sql`CREATE INDEX \`_pages_v_parent_idx\` ON \`_pages_v\` (\`parent_id\`);`)
  await db.run(sql`CREATE INDEX \`_pages_v_version_version_slug_idx\` ON \`_pages_v\` (\`version_slug\`);`)
  ...
  `)
  await db.run(sql`INSERT INTO \`__new_payload_locked_documents_rels\`("id", "order", "parent_id", "path", "media_id", "artists_id", "exhibitions_id", "viewing_rooms_id", "press_id", "events_id", "pages_id", "users_id", "clients_id") SELECT "id", "order", "parent_id", "path", "media_id", "artists_id", "exhibitions_id", "viewing_rooms_id", "press_id", "events_id", "pages_id", "users_id", "clients_id" FROM \`payload_locked_documents_rels\`;`)
  await db.run(sql`DROP TABLE \`payload_locked_documents_rels\`;`)
  await db.run(sql`ALTER TABLE \`__new_payload_locked_documents_rels\` RENAME TO \`payload_locked_documents_rels\`;`)
  await db.run(sql`CREATE INDEX \`payload_locked_documents_rels_order_idx\` ON \`payload_locked_documents_rels\` (\`order\`);`)
  await db.run(sql`CREATE INDEX \`payload_locked_documents_rels_parent_idx\` ON \`payload_locked_documents_rels\` (\`parent_id\`);`)
