...
export async function up({ db, payload, req }: MigrateUpArgs): Promise<void> {
  ...
  `)
  await db.run(sql`INSERT INTO \`__new_artists\`("id", "title", "slug", "slug_lock", "profile_image_id", "first_name", "middle_name", "last_name", "suffix", "nationality", "birth_year", "death_year", "content", "social_links_website", "social_links_instagram", "social_links_twitter", "cv_upload_id", "meta_title", "meta_description", "meta_image_id", "updated_at", "created_at") SELECT "id", "title", "slug", "slug_lock", "profile_image_id", "first_name", "middle_name", "last_name", "suffix", "nationality", "birth_year", "death_year", "content", "social_links_website", "social_links_instagram", "social_links_twitter", "cv_upload_id", "meta_title", "meta_description", "meta_image_id", "updated_at", "created_at" FROM \`artists\`;`)
