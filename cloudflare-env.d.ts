/* eslint-disable */
// Generated by Wrangler by running `wrangler types --env-interface CloudflareEnv cloudflare-env.d.ts` (hash: 91ece2c55ee34524ee922ee4ae85cfd0)
...
declare namespace Cloudflare {
	...
	interface Env {
		...
		DEV_MAILCHIMP_AUDIENCE: string;
		MAILCHIMP_DEV_API: string;
		DEV_MAILER: string;
		NEXT_PUBLIC_FATHOM_ID: string;
		NEXT_PUBLIC_SERVER_URL: string;
		FATHOM_DASHBOARD: string;
		R2: R2Bucket;
		D1: D1Database;
...
declare namespace NodeJS {
	interface ProcessEnv extends StringifyValues<Pick<Cloudflare.Env, "PAYLOAD_SECRET" | "PREVIEW_SECRET" | "CLOUDFLARE_ACCOUNT_ID" | "RESEND_API_KEY" | "NEXTJS_ENV" | "MAILCHIMP_API_KEY" | "PROD_MAILER" | "MAILCHIMP_AUDIENCE_ID" | "DEV_MAILCHIMP_AUDIENCE" | "MAILCHIMP_DEV_API" | "DEV_MAILER" | "NEXT_PUBLIC_FATHOM_ID" | "NEXT_PUBLIC_SERVER_URL" | "FATHOM_DASHBOARD">> {}
}
